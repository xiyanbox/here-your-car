...
@Form.create()
export default class LearnInfo extends PureComponent {
  state = {
    addInputValue: '',
    modalVisible: false,
    expandForm: false,
            ...
            <FormItem label="缴费情况">
              {getFieldDecorator('number',{
                ...
                <RadioGroup name="radiogroup">
                      <Radio value={1}>待交费</Radio>
                      <Radio value={2}>已缴费</Radio>
                </RadioGroup>
                   )}
            </FormItem>
          </Col>
          ...
          <Col span={8}>
            <FormItem label="入校时间">
              {getFieldDecorator('date')(
                <DatePicker style={{ width: '100%' }} placeholder="请输入入校日期" />
              )}
            </FormItem>
          </Col>
          <Col span={8}>
            <FormItem label="教练姓名">
              {getFieldDecorator('status3',{
                ...
                <Select placeholder="请选择" style={{ width: '100%' }}>
                  <Option value="1">王二虎</Option>
                  <Option value="2">张三猫</Option>
                  <Option value="3">李大狗</Option>
                  <Option value="4">赵四熊</Option>
                </Select>
              )}
            </FormItem>
          </Col>
